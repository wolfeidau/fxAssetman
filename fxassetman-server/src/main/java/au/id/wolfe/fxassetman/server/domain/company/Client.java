...
/**
 * Represents a client company which assets are managed in the fxassetman system.
 */

/**
 * Represents a company that manufactures products which are stored as assets.
 */
@Entity
@Table(name = "clients")
